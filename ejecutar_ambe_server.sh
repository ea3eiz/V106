...
sleep 1
xterm -geometry 88x6+1122+49 -bg black -fg white -fa â€verdanaâ€ -fs 9x -T CONSLOLA_AMBEserber -e ./AMBEserver -p $puerto_router -i $puerto_modem -s $baut_rate



cd /home/pi/Desktop
sudo cp Abrir_ambe_server.desktop /home/pi
sed -i "4c Exec=sh -c 'cd /home/pi/$SCRIPTS_version;sudo sh ejecutar_ambe_server.sh'" /home/pi/Abrir_ambe_server.desktop
