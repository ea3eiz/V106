...
sed -i "6c Exec=sh -c 'cd /home/pi/$SCRIPTS_version/;lxterminal --geometry=77x18 --title=SOLOFUSION -e sudo sh ejecutar_solofusion.sh'" /home/pi/Abrir_solofusion.desktop
