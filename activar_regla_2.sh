...
sleep 2
sudo sed "40c $aline40" /opt/HBlink3/rules.py

line41=$(awk "NR==41" /opt/HBlink3/rules.py)
aline41=${line41:1:-1} 
sleep 2
sudo sed '41c $aline41' /opt/HBlink3/rules.py

line42=$(awk "NR==42" /opt/HBlink3/rules.py)
aline42=${line42:1:-1}
sleep 2
sudo sed "42c $aline42" /opt/HBlink3/rules.py

line43=$(awk "NR==43" /opt/HBlink3/rules.py)
aline43=${line43:1:-1}
sleep 2
sudo sed "43c $aline43" /opt/HBlink3/rules.py
