...
if ($sistema=="ESPECIAL"){
 ?>   
    ...
    <div style="font-size:23px;background:#0000FF;height:50px;text-align:center;padding-top:2px" class="col-md-6">
        <span style="font-size:30px;color:#FFFFFF"><?php echo $sistema;?> </span><span class="ipcs2"><?php echo $IPCS22;?> <?php echo $OPTION;?></span>
    </div>
...
elseif ($sistema=="NXDN") {
?> 
    <div style="font-size:23px;background:#FC02FF;height:50px;text-align:center;padding-top:2px" class="col-md-6">
        <span style="font-size:30px;color:#FFFFFF"><?php echo $sistema;?> </span><span class="ipcs2"><?php echo $IPCS22;?> <?php echo $OPTION;?></span>
    </div>
...
elseif ($sistema=="YSF") {
?> 
    <div style="font-size:23px;background:#F184D6;height:50px;text-align:center;padding-top:2px" class="col-md-6">
        <span style="font-size:30px;color:#FFFFFF"><?php echo $sistema;?> </span><span class="ipcs2"><?php echo $IPCS22;?> <?php echo $OPTION;?></span>
    </div>

<?php 
}
elseif ($sistema=="D-STAR") {
?> 
    <div style="font-size:23px;background:#5A9A17;height:50px;text-align:center;padding-top:2px" class="col-md-6">
        <span style="font-size:30px;color:#FFFFFF"><?php echo $sistema;?> </span><span class="ipcs2"><?php echo $IPCS22;?> <?php echo $OPTION;?></span>
    </div>
...
elseif ($sistema=="FCS") {
?> 
    <div style="font-size:23px;background:#804002;height:50px;text-align:center;padding-top:2px" class="col-md-6">
        <span style="font-size:30px;color:#FFFFFF"><?php echo $sistema;?> </span><span class="ipcs2"><?php echo $IPCS22;?> <?php echo $OPTION;?></span>
    </div>

<?php 
}
elseif ($sistema=="BRANDMEISTER") {
?> 
    <div style="font-size:23px;background:#F00000;height:50px;text-align:center;padding-top:2px" class="col-md-6">
        <span style="font-size:30px;color:#FFFFFF"><?php echo $sistema;?> </span><span class="ipcs2"><?php echo $IPCS22;?> <?php echo $OPTION;?></span>
    </div>
...
elseif ($sistema=="DMR+") {
?> 
    <div style="font-size:23px;background:#999999;height:50px;text-align:center;padding-top:2px" class="col-md-6">
        <span style="font-size:30px;color:#FFFFFF"><?php echo $sistema;?> </span><span class="ipcs2"><?php echo $IPCS22;?> <?php echo $OPTION;?></span>
    </div>
...
<form method="post" action="cambia_sala_nxdn.php"/>
        ...
        <input name="sala_nxdn" class="fuente_boton3 form-control" placeholder="Ej. 21465 aderdigital.ddns.net 41400 + Enter">    
