...
sed -i "6c Exec=sh -c 'cd /home/pi/$SCRIPTS_version; lxterminal --geometry=77x18 --title=SOLODSTAR -e sudo sh ejecutar_solodstar.sh'" /home/pi/Abrir_solodstar.desktop
