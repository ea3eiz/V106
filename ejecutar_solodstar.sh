...
cd /home/pi/Desktop
sudo cp Abrir_solodstar.desktop /home/pi
sed -i "6c Exec=sh -c 'cd /home/pi/$SCRIPTS_version; lxterminal --geometry=77x18 --title=SOLO DSTAR -e sudo sh ejecutar_solodstar.sh'" /home/pi/Abrir_solodstar.desktop
